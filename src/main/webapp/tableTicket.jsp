								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img
													src="<%=request.getContextPath()%>/Template/img/team-2.jpg"
								...
								<li class="mb-2"><a class="dropdown-item border-radius-md"
									href="javascript:;">
										<div class="d-flex py-1">
											<div class="my-auto">
												<img
													src="<%=request.getContextPath()%>/Template/img/small-logos/logo-spotify.svg"
...
<%@ include file="/include3/footer.jsp"%>
</body>
