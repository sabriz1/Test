<aside
	...
	<div class="sidenav-header">
		<i
			...
			target="_blank"> <img src="<%= request.getContextPath() %>/Template/img/logo-ct.png"
			class="navbar-brand-img h-100" alt="main_logo"> <span
			class="ms-1 font-weight-bold">Soft UI Dashboard</span>
		</a>
	</div>
	<hr class="horizontal dark mt-0">
	<div class="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps"
		...
		<ul class="navbar-nav">
			...
			<li class="nav-item">
			<a class="nav-link  active" href="<%= request.getContextPath() %>/table.jsp">
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-1869.000000, -293.000000)"
					...
					</div> <span class="nav-link-text ms-1">TableSection</span>
			</a></li>
			<li class="nav-item"><a class="nav-link  "
				href="<%= request.getContextPath() %>/tablePlace.jsp">
					<div
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-2169.000000, -745.000000)"
					...
					</div> <span class="nav-link-text ms-1">TablePlace</span>
			</a></li>
			<li class="nav-item"><a class="nav-link  "
				href="<%= request.getContextPath() %>/tableTicket.jsp">
					<div
						class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
						<svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
							xmlns="http://www.w3.org/2000/svg"
                ...
                <g stroke="none" stroke-width="1" fill="none"
                  ...
                  <g transform="translate(-2319.000000, -291.000000)"
					...
					</div> <span class="nav-link-text ms-1">TableTicket</span>
			</a></li>
			<li class="nav-item"><a class="nav-link  "
				href="../pages/rtl.html">
					<div
	...
	<div class="sidenav-footer mx-3 ">
		<div
			...
			<div class="full-background"
				style="background-image: url('<%= request.getContextPath() %>/Template/img/curved-images/white-curved.jpeg')"></div>
